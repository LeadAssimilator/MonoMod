...
namespace MonoMod.UnitTest.Core
{
    public class DetouringMethodsReturningStructs : TestBase
    {
        ...
        private class StaticHolder
        {
            ...
            {
                Console.WriteLine("Original static should never be called (" + s + ")");
                return new St01();
            }

            public static St01 ReplacementStatic01(string s)
            {
                Console.WriteLine("Replacement static called with " + s);
                return new St01();
            }
        ...
        private class InstanceHolder
        {
            ...
            {
                Console.WriteLine("Original instance should never be called (" + s + ")");
                return new St01();
            }

            public static St01 ReplacementInstance01(InstanceHolder _, string s)
            {
                Console.WriteLine("Replacement instance called with " + s);
                return new St01();
            }
